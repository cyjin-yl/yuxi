...
**Σ<sub>m=2…len</sub> C(2<sup>k</sup>−1, m)**
...
**Σ<sub>i=1…2<sup>p</sup>−1</sub> C(2<sup>k</sup>−1−i, len)**

### 最终答案

第一种情况累加：**Σ<sub>m=2…len</sub> C(2<sup>k</sup>−1, m)**

第二种情况（仅当 \(p > 0\)）累加：**Σ<sub>i=1…2<sup>p</sup>−1</sub> C(2<sup>k</sup>−1−i, len)**
